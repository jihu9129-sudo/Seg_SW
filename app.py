...
MODEL_URL = "https://drive.google.com/file/d/1SO-ZjcLMXR0GEKc4Tb7Td6MePgR2B833/view?usp=sharing"  # Google Drive 공유 링크 ID
IMG_SIZE = 256
...
def load_model(path=MODEL_PATH):
    ...
    if os.path.exists(path):
        ...
        st.warning(f"모델 파일가 없습니다: {path} — 랜덤 초기화 모델 사용")
    m.eval()
    return m
